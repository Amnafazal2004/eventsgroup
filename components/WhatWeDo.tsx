  ...
  return (
    <section className="w-full bg-black text-white py-12 md:py-16 lg:py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-12">
        ...
        {/* Heading */}
        <motion.h2
          className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-center font-bold mb-12 sm:mb-16 md:mb-20 lg:mb-24 ${guttie.className}`}
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          {/* LEFT SIDE — SINGLE IMAGE ON MOBILE, CARD FAN ON DESKTOP */}
          <motion.div
          ...
          >
            ...
            {/* Desktop: Animated Card Fan */}
            <div className="hidden lg:block relative w-[460px] h-[420px]">
          ...
          >
            <Accordion type="single" collapsible className="w-full space-y-4 sm:space-y-6">
              ...
              <AccordionItem
                value="item-1"
                className="border-b border-gray-700 pb-4 sm:pb-5"
              >
                <AccordionTrigger className={`text-lg sm:text-xl md:text-2xl font-bold hover:no-underline ${guttie.className}`}>
                  EVENT MANAGEMENT
                </AccordionTrigger>
                <AccordionContent className="text-gray-300 font-[fahkwang] text-sm sm:text-base mt-2 sm:mt-3 leading-relaxed">
