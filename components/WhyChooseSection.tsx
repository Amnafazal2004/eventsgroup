...
const features = [
  {
    icon: Brain,
    title: "AI-Centered",
    desc: "We think about how AI can provide more efficiency and personalization, driving process innovation.",
  },
  {
    icon: Search,
    title: "Embedded Research",
    desc: "We use data to strengthen hypotheses and identify risks. Our research team ensures the customer has the loudest voice.",
  },
  {
    icon: Layers,
    title: "Systems First",
    desc: "Process is at the core of every partnership. We help clients sustain new growth with systems and infrastructure.",
  },
  {
    icon: Zap,
    title: "Dedicated Speed",
    desc: "Clients come to us when they need to adapt, shift, and scale. We work quickly with early prototyping.",
  },
];
